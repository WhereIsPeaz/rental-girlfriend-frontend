                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="flex items-center space-x-3">
                                            ...
                                            {booking.status === 'completed' &&
                                                ...
                                                <button
                                                onClick={() => router.push(`/summaryreview/${booking.id}`)}
                                                className="flex items-center gap-2 rounded-xl border border-gray-300 px-4 py-2 text-gray-700 hover:bg-gray-100 transition"
                                            >
